...
public class MaterialProgressDrawable extends Drawable implements Animatable {
     ...
     *
     * @param size One of
     *             {@link com.takeoffandroid.material.MaterialProgressDrawable.LARGE}
     *             or
    ...
    private static class Ring {
         ...
         *
         * @param colors Array of integers describing the colors. Must be non-
         *               <code>null</code>.
         */
        ...
        /**
         * @param index Index into the color array of the color to display in the
         *              progress spinner.
         */
        ...
        /**
         * @param centerRadius Inner radius in px of the circle the progress spinner arc
         *                     traces.
         */
        ...
        /**
         * @param show Set to true to show the arrow head on the progress
         *             spinner.
         */
