...
/**
 * This class holds track information. It is passed to Ambience and the
 * AmbientService for playback.
 *
...
public class AmbientTrack implements Parcelable {
    ...
    public static final String TAG = "com.radioayah.ambience.AmbientTrack";
    ...
    public AmbientTrack setAudioDownloadUri(Uri audioDownload) {
        ...
        audioDownloadUri = audioDownload;
        ...
        for (int x = 0; x < genres.size(); x++) {
            if (genres.get(x) == null) {
                throw new NullPointerException(TAG
                        + ": cannot contain a null object in the genre list");
            }
        }
